  ...
  categories: [
    {
      ...
      subcategories: [
        ...
        { name: "Dispenser Copos", slug: "dispenser-copos" },
    ...
    },
    {
      ...
      icon: "flask-conical",
      subcategories: [
        { name: "Indústria de Alimentos e Bebidas", slug: "industria-de-alimentos-e-bebidas" },
        { name: "Lavanderias Industriais", slug: "lavanderias-industriais" },
        { name: "Food Service", slug: "food-service" },
        { name: "Supermercados", slug: "supermercados" },
        { name: "Frigorífico & Abastecimento", slug: "frigorifico--abastecimento" },
        { name: "Hotelaria", slug: "hotelaria" },
        { name: "Educação", slug: "educacao" },
        { name: "Higiene Automotiva", slug: "higiene-automotiva" },
        { name: "Tratamento de Pisos", slug: "tratamento-de-pisos" },
        { name: "Álcool 70°", slug: "alcool-70" },
        { name: "Hospitalar", slug: "hospitalar" },
        { name: "Indústrias em Geral", slug: "industrias-em-geral" },
        { name: "Equipamentos Homologados", slug: "equipamentos-homologados" },
      ],
    },
  ],
} as const
